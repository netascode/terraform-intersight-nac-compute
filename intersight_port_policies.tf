...
resource "intersight_fabric_port_policy" "port_policy" {
  for_each = var.manage_intersight_policies ? { for p in local.port_policies : p.key => p } : {}
...
resource "intersight_fabric_port_mode" "port_mode" {
  for_each = var.manage_intersight_policies ? { for m in local.port_modes : m.key => m } : {}
...
resource "intersight_fabric_server_role" "server_role" {
  for_each = var.manage_intersight_policies ? { for r in local.port_role_servers : r.key => r } : {}
...
resource "intersight_fabric_uplink_role" "uplink_role" {
  for_each = var.manage_intersight_policies ? { for r in local.port_role_ethernet_uplinks : r.key => r } : {}
...
resource "intersight_fabric_uplink_pc_role" "uplink_pc_role" {
  for_each = var.manage_intersight_policies ? { for c in local.port_channel_ethernet_uplinks : c.key => c } : {}
...
resource "intersight_fabric_fc_uplink_role" "fc_uplink_role" {
  for_each = var.manage_intersight_policies ? { for r in local.port_role_fc_uplinks : r.key => r } : {}
...
resource "intersight_fabric_fc_uplink_pc_role" "fc_uplink_pc_role" {
  for_each = var.manage_intersight_policies ? { for c in local.port_channel_fc_uplinks : c.key => c } : {}
...
resource "intersight_fabric_fcoe_uplink_role" "fcoe_uplink_role" {
  for_each = var.manage_intersight_policies ? { for r in local.port_role_fcoe_uplinks : r.key => r } : {}
...
resource "intersight_fabric_fcoe_uplink_pc_role" "fcoe_uplink_pc_role" {
  for_each = var.manage_intersight_policies ? { for c in local.port_channel_fcoe_uplinks : c.key => c } : {}
...
resource "intersight_fabric_appliance_role" "appliance_role" {
  for_each = var.manage_intersight_policies ? { for r in local.port_role_appliances : r.key => r } : {}
...
resource "intersight_fabric_appliance_pc_role" "appliance_pc_role" {
  for_each = var.manage_intersight_policies ? { for c in local.port_channel_appliances : c.key => c } : {}
...
resource "intersight_fabric_fc_storage_role" "fc_storage_role" {
  for_each = var.manage_intersight_policies ? { for r in local.port_role_fc_storage : r.key => r } : {}
