...
locals {
  ...
  scrub_policy_moids = var.manage_intersight_policies ? tomap({
    for k, r in intersight_compute_scrub_policy.scrub_policy : k => r.moid
    }) : tomap({
  ...
  drive_security_policy_moids = var.manage_intersight_policies ? tomap({
    for k, r in intersight_storage_drive_security_policy.drive_security_policy : k => r.moid
    }) : tomap({
  ...
  sd_card_policy_moids = var.manage_intersight_policies ? tomap({
    for k, r in intersight_sdcard_policy.sd_card_policy : k => r.moid
    }) : tomap({
  ...
  memory_policy_moids = var.manage_intersight_policies ? tomap({
    for k, r in intersight_memory_policy.memory_policy : k => r.moid
    }) : tomap({
  ...
  persistent_memory_policy_moids = var.manage_intersight_policies ? tomap({
    for k, r in intersight_memory_persistent_memory_policy.persistent_memory_policy : k => r.moid
    }) : tomap({
